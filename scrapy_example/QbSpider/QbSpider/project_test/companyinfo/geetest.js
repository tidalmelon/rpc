...
!function (a, b) {
    ...
    function c(a, b) {
        ...
        var d = this;
        return d.id = o(), k.S(d.id), Q.S(d.id, d), k.U("error", ra.onError, d.id), d.config = B(a, d), d.config.protocol = d.config.https ? "https://" : location.protocol + "//", "https://" === d.config.protocol && (d.config.https = !0), b || a.offline ? (P(!1, a, d), a.popupbtnid && d.bindOn("#" + a.popupbtnid)) : G(d.config.apiserver + "get.php?" + m(a), P, d), O(d), d
    }
    ...
    var g = {}, h = {}, i = function (a) {
        ...
        b in h ? "loaded" === h[b].status ? c && c(h[b].content) : "loading" === h[b].status ? k.P(b + "Loaded", function () {
            c && c(h[b].content)
        }) : w("module " + b + " lost!") : (h[b] = {status: "loading"}, F(a, "js/" + b.toLowerCase() + "." + a.config.version + ".js", function (d) {
            return d ? (w("module " + b + " can not loaded"), void k.q("error", a.id)) : void j(a, b, c)
        }))
    };
    g.Q = function (a, b, c) {
        var d;
        ...
        return h[a] = {}, h[a].status = "loaded", h[a].content = d, k.R(a + "Loaded"), d
    };
    var k = {};
    k.z = {}, k.z.global = {}, k.S = function (a) {
        k.z[a] = {}
    }, k.T = function (a) {
        k.z[a] = void 0
    }, k.U = function (a, b, c) {
        return c ? (k.z[c][a] || (k.z[c][a] = []), void k.z[c][a].push({
            once: !1,
            callback: b
        })) : (k.z.global[a] || (k.z.global[a] = []), void k.z.global[a].push({once: !1, callback: b}))
    }, k.P = function (a, b, c) {
        c ? (k.z[c][a] || (k.z[c][a] = []), k.z[c][a].push({
            once: !0,
            callback: b
        })) : (k.z.global[a] || (k.z.global[a] = []), k.z.global[a].push({once: !0, callback: b}))
    }, k.V = function (a, b, c) {
        var d;
        d = c ? k.z[c][a] : k.z.global[a], d.splice(p(b, d), 1)
    }, k.W = function (a, b) {
        q(k.z, b)
    }, k.q = function (a, b) {
        var c, d = k.z[b][a];
        if (d)for (var e = 0; e < d.length; e++)c = d[e], c && (c.callback.call(Q.f("self", b)), c.once && (k.V(a, c, b), e -= 1))
    }, k.R = function (a) {
        var b, c = k.z.global[a];
        if (c)for (var d = 0; d < c.length; d++)b = c[d], b && (b.callback(), b.once && (k.V(a, b), d -= 1))
    };
    var l = function (a, b) {
        var c = b || {};
        ...
        var a = function (a, b) {
            ...
            var b = 0;
            if (v(a))b = a.length; else for (var c in a)a.hasOwnProperty(c) && (b += 1);
            return b
        };
        return {d: a, X: b}
    }(), y = {
        ...
        var d = a.config.staticservers, e = a.config.protocol, f = d.length, g = 0, h = function (a, b) {
        ...
        var i = function (a, b) {
            ...
            return g >= f ? (b.indexOf("pictures") === -1 && k.q("error", a.id), void c(!0, d)) : void(b.indexOf(".js") > -1 ? E(h(g, b), i) : b.indexOf(".png") > -1 || b.indexOf(".jpg") > -1 || b.indexOf(".webp") > -1 || b.indexOf(".svg") > -1 ? C(h(g, b), i) : b.indexOf(".css") > -1 ? D(a, h(g, b), i) : (b && w("no such resource: " + b), c(!0, d)))
        };
        j(null)
    }, G = function (a, b, c) {
        ...
        var d = "geetest_" + o();
        window[d] = function (a) {
            a.error && (w(a.error), k.q("error", c.id), k.q("statusChange", c.id), q(window, d)), b.call(c, !1, a, c)
        }, E(a + "&callback=" + d, function (b) {
            b && (w("GeeTest Error: request " + a + " can not access"), k.q("error", c.id), k.q("statusChange", c.id), q(window, d))
        })
    }, H = document.createElement("img");
    H.onload = H.onerror = function () {
        var a = ".jpg";
        2 === H.height && (a = ".webp"), z.webp = a, k.R("WebPLoaded")
    }, H.src = "data:image/webp;base64,UklGRi4AAABXRUJQVlA4TCEAAAAvAUAAEB8wAiMwAgSSNtse/cXjxyCCmrYNWPwmHRH9jwMA";
    var I = /msie 6/i.test(navigator.userAgent), J = -1, K = /msie|trident\/|edge/i.test(navigator.userAgent), L = function () {
    ...
    var M = function (a, b) {
        ...
        if (!K)return !0;
        var b = "178273px", c = Q.f("styleDetectEle", a.id);
        return !(!c || M(c, "width") !== b) && (c.parentNode.removeChild(c), Q.p("styleDetectEle", !1, a.id), !0)
    }, O = function (a) {
        if (K) {
            var b = document.createElement("div");
            b.id = "geetest_style_detect_178273px", Q.p("styleDetectEle", b, a.id), document.getElementsByTagName("body")[0].appendChild(b)
        }
    };
    c.type = "slide";
    var P = function (a, b, c) {
        return !(a || !b) && (c.config.debugConfig && (b = l(c.config.debugConfig, b), c.config = B(b, c)), J == -1 && L(), void f.parallel([function (a) {
                ...
                e && e.h(), b.offline ? c.config = B(d.h(c), c) : c.config = B(b, c), k.U("success", ra.onSuccess, c.id), k.U("refresh", ra.onRefresh, c.id), k.U("fail", ra.onFail, c.id), k.U("forbidden", ra.onForbidden, c.id), k.U("abuse", ra.onAbuse, c.id), k.P("DOMReady", function () {
                    c.config.benchmark && i("Benchmark").h(c), "popup" === c.config.product && ia.h(c)
                }, c.id), k.P("DOMReady", ra.onReady, c.id), f.serial([function (a) {
                    ...
                    if (z.loaded_theme[c.config.theme])c.config.mobile && !z.mobileSkins[c.config.theme] ? k.P(c.config.theme + "Loaded", function () {
                        Q.p("loaded", !0, c.id), k.q("loaded", c.id)
                    }) : (Q.p("loaded", !0, c.id), k.q("loaded", c.id)); else if (z.loaded_theme[c.config.theme] = !0, c.config.mobile) {
                        if (window.GeeTestSkins && window.GeeTestSkins[c.config.theme])return z.mobileSkins[c.config.theme] = window.GeeTestSkins[c.config.theme], Q.p("loaded", !0, c.id), void k.q("loaded", c.id);
                        F(c, c.config.theme + "/skin." + c.config.theme_version + ".js", function (a) {
                            return a ? (w("svg " + c.config.theme + " skin.js can not loaded"), void k.q("error", c.id)) : (z.mobileSkins[c.config.theme] = window.GeeTestSkins[c.config.theme], k.R(c.config.theme + "Loaded"), Q.p("loaded", !0, c.id), void k.q("loaded", c.id))
                        })
                    } else f.parallel([function (a) {
                        F(c, c.config.theme + "/style" + (c.config.https ? "_https" : "") + "." + c.config.theme_version + ".css", function (b) {
                            b && k.q("error", c.id), a(null, !0)
                        })
                    }, function (a) {
                        setTimeout(function () {
                            a(null, !0)
    ...
    S.v = function ta(a, b, c) {
        ...
        for (d in a)if (a.hasOwnProperty(d)) {
            ...
            "input" === h ? (f = document.createElement(h), f.className = i, f.type = "hidden", f.name = i) : (f = document.createElement(h), f.className = i), b.appendChild(f), c(f, "." + i.split(" ")[0]), ta(a[d], f, c)
        }
        ...
        return {
            ".gt_widget": {
                ...
                ".gt_box_holder": {
                    ".gt_box": {
                        ".gt_loading": {".gt_loading_icon": {}, ".gt_loading_text": b.loading},
        ...
        a.style.top = S.ca(b) - 160 + "px", a.style.left = S.ba(b) + "px"
    }, S.ea = function (a, b) {
        var c = this;
        a = S._(a, "appendTo"), S.fa(c);
        var d = c.$;
        if ("gyroscope" === c.config.type)i("Gyro").h(c).g(c).w(c); else if (c.config.mobile) {
            var e = i("SVG");
            e.h(c), e.g(c), e.w(c)
        } else {
            if ("popup" !== c.config.product)c.dom = S.v(S.Y(c.config.lang), !1, d); else {
                var f = i("Popup");
                c.dom = S.v(f.Y(c.config.lang), !1, d)
            }
            if (S.ga(c, !0), S.ha(c), S.ia(c), S.ka(c, !0), ba.la(c), "curtain" === c.config.type) {
                var g = i("Curtain");
                g.la(c)
            }
            d(".gt_flash").style.height = c.config.height - 22 + "px"
        }
        if (c.dom.style["touch-action"] = "none", c.dom.style["ms-touch-action"] = "none", ma(c), c.dom.id = "geetest_" + c.id, c.config.mobile ? c.dom.className = "gt_mobile_holder " + c.config.product : c.dom.className = "gt_holder " + c.config.product, "float" != c.config.product || c.config.mobile || ha(c), "popup" != c.config.product || c.config.mobile)b ? S.Z(a, c.dom) : a.appendChild(c.dom); else {
            document.body.appendChild(c.dom);
            var h = d(".gt_input");
            b ? S.Z(a, h) : a.appendChild(h)
        }
        if ("gyroscope" === c.config.type && Q.p("scale", c.dom.clientWidth / 260, c.id), "float" === c.config.product && !c.config.mobile)if (c.config.sandbox) {
            var j = d(".gt_widget");
            c.dom.removeChild(j);
            var l = document.createElement("div");
            l.className = c.dom.className + " gt_clone", l.appendChild(j), document.getElementsByTagName("body")[0].appendChild(l), S.da(l, c.dom), c.cloneDom = l
        } else setTimeout(function () {
            S.aa(c.dom)
        }, 2e3);
        Q.p("DOMReady", !0, c.id), k.q("DOMReady", c.id)
    }, S.ga = function (a, b) {
        var c = a.$;
        if (T.o(c(".gt_curtain")), T.o(c(".gt_curtain_button")), T.o(c(".gt_curtain_tip")), T.o(c(".gt_curtain_knob")), "slide" == a.config.type)ba.ma(a, b); else {
            var d = i("Curtain");
            ba.o(a, b), d.ma(a, b)
        }
    }, S.ia = function (a) {
        var b = a.$, c = b(".gt_logo_button");
        a.config.logo ? (c.href = z.homepage, c.target = "_blank") : S.na(c, "no_logo"), a.config.clean && S.na(b(".gt_widget"), "clean");
        ...
        if (a) {
            ...
            for (var d, e = c.split(" "), f = a.className.split(" "), g = 0, h = e.length; g < h; g++)d = p(e[g], f), d != -1 && f.splice(d, 1);
            a.className = f.join(" ")
        }
    }, S.pa = function (a, b) {
        ...
        var d = function () {
            var d = new Date, e = x.X(b), f = {}, g = !1, h = 0, i = function () {
                if (!(h < e))if (g)a.config.retry += 1, Q.p("status", "auto", a.id), a.refresh(); else {
                    a.config.retry = 0;
        ...
        var e = a.config.type;
        if ("slide" == e)S.x(a, {fullbg: a.config.fullbg, bg: a.config.bg, slice: a.config.slice}, function (d, e) {
            U.qa(d.fullbg.src, d.bg.src, a, b), Q.p("imgload", e, a.id);
            var f = c(".gt_slice");
            I ? f.style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + d.slice.src + '")' : (f.style.backgroundImage = "url(" + d.slice.src + ")", f.style.width = (d.slice.width || 60) + "px", f.style.height = (d.slice.height || 60) + "px"), f.style.left = a.config.xpos + "px", f.style.top = a.config.ypos + "px", setTimeout(function () {
                Q.p("status", "ready", a.id), pa.ma("ready", a), k.q("statusChange", a.id)
            }, 400)
        }); else {
            var f = 900;
            b && (f = 0), S.x(a, {fullbg: a.config.fullbg, bg: a.config.bg}, function (d, e) {
                var g = c(".gt_curtain_button");
                Q.p("imgload", e, a.id), g.style.top = a.config.ypos + "px", g.style.left = a.config.xpos + "px", U.qa(d.fullbg.src, d.bg.src, a, b), setTimeout(function () {
                    Q.p("status", "ready", a.id), pa.ma("ready", a), k.q("statusChange", a.id)
                }, f)
            })
        }
    ...
    var T = function () {
        var a = S.na, b = S.oa, c = function (c, d, e) {
            var f = function () {
        ...
        var a = function () {
            ...
            b.style.backgroundImage = "none", d.style.backgroundImage = "none", g.style.backgroundImage = "none", f.style.backgroundImage = "none", T.o(b), T.o(d), T.o(g), T.o(f), T.o(c), T.o(e)
        }, c = function (a, b) {
            var c = 300, d = 600;
            b && (c = d = 0);
            var e = a.$;
            T.ma(e(".gt_fullbg"), c), "slide" == a.config.type ? (T.ma(e(".gt_bg"), 0, c), T.ma(e(".gt_slice"), 0, c)) : (T.ma(e(".gt_curtain"), d), T.ma(e(".gt_curtain_button"), d))
        }, d = function (b, c, d, e, f) {
            var g = c.split("/pictures/gt/")[1].split("/"), h = 8 !== g[0].length;
            if (!h)return void(d.style.backgroundImage = "url(" + c + ")");
            var i, j, k, l = [];
            if (Q.f(b + "Arr", f.id))for (l = Q.f(b + "Arr", f.id), i = 0, j = l.length; i < j; i++)l[i].style.backgroundImage = "url(" + c + ")"; else {
                Q.p(b + "Arr", l, f.id);
                var m, n = a(), o = document.createElement("div");
                for (o.className = "gt_cut_" + b + "_slice", i = 0, j = n.length; i < j; i++)
        ...
        return {qa: e, ra: b, sa: f, e: g}
    }(), V = "move", W = "down", X = "up", Y = "scroll", Z = "blur", $ = "focus", _ = "unload", aa = {};
    aa.evts = {
        ...
        focus: [$],
        unload: [_]
    }, aa.z = [], aa.f = function (a, b) {
        for (var c, d = 0, e = aa.z.length; d < e; d++)if (c = aa.z[d], c.dom == a && c.event == b)return c;
        return c = {
            dom: a, event: b, handlerList: [], ta: function () {
            }
        }, aa.z.push(c), c
    }, aa.u = function (a, b, c) {
        for (var d, e = aa.evts[b], f = aa.f(a, b), g = 0, h = e.length; g < h; g++)f.handlerList.length && (d = f.ta, window.addEventListener ? a.removeEventListener(e[g], d, !1) : window.attachEvent && a.detachEvent("on" + e[g], d)), window.addEventListener ? (f.handlerList.push(c), f.ta = function (b) {
        ...
        var d = aa.evts[b], e = aa.f(a, b);
        e.handlerList = [];
        for (var f = 0, g = d.length; f < g; f++)window.removeEventListener ? a.removeEventListener(d[f], c, !1) : window.detachEvent && a.detachEvent("on" + d[f], c)
    };
    var ba = {};
    ba.ma = function (a) {
        var b = a.$;
        ba.l(0, a, !0), T.ma(b(".gt_guide_tip"), 500), T.ma(b(".gt_slider_knob"), 500)
    }, ba.o = function (a) {
        var b = a.$;
        T.o(b(".gt_bg"), 500), T.o(b(".gt_slider_knob"), 500), T.o(b(".gt_guide_tip"), 500), setTimeout(function () {
            ba.l(0, a, 0)
        }, 500)
    }, ba.ta = function (a, b) {
        var c = this, d = c.$, e = d(".gt_slice"), f = d(".gt_slider_knob");
        if (b && b.type)return oa.ma("fail", c, 3e3), pa.ma("lock", c), T.ma(d(".gt_fullbg"), 300), void setTimeout(function () {
            la(b, c)
        }, 500);
        if (a || "error" === b.message)oa.ma("error", c), pa.ma("error", c), Q.p("status", "error", c.id), k.q("error", c.id); else if (b.success) {
            var g = d(".gt_flash");
            Q.p("score", b.score, c.id), oa.ma("success", c), pa.ma("success", c), J || T.ma(d(".gt_ie_success")), T.ma(g, 1500), T.o(g, 0, 1600), T.ma(d(".gt_fullbg"), 1500), qa.va(b.validate, c), k.q("success", c.id), setTimeout(function () {
                Q.p("status", "success", c.id), k.q("statusChange", c.id)
            }, 400)
        } else"fail" == b.message ? (oa.ma("fail", c), pa.ma("fail", c), T.o(e, 100), T.ma(e, 100, 100), T.o(e, 100, 200), T.ma(e, 100, 300), T.l(e, 400, 500, !1, function () {
            ba.l(0, c, !0)
        }), T.l(f, 400, 500), k.q("fail", c.id), setTimeout(function () {
            Q.p("status", "ready", c.id), pa.ma("ready", c), k.q("statusChange", c.id), T.ma(d(".gt_guide_tip"), 500)
        }, 1e3)) : "forbidden" == b.message ? (oa.ma("forbidden", c), pa.ma("forbidden", c), k.q("forbidden", c.id), setTimeout(function () {
            Q.p("status", "auto", c.id), c.refresh()
        }, 4e3)) : "abuse" == b.message && (oa.ma("abuse", c), pa.ma("fail", c), k.q("abuse", c.id), setTimeout(function () {
            Q.p("status", "auto", c.id), c.refresh()
        }, 1500))
    }, ba.l = function (a, b, c) {
        ...
        return function (c) {
            ...
            if ("ready" == d && "slide" == a.config.type && 2 != c.button) {
                ...
                "pointerdown" !== c.type || Q.f("pointerdown", a.id) || Q.p("pointerdown", !0, a.id), Q.p("startTime", new Date, a.id), Q.p("status", "moving", a.id), k.q("statusChange", a.id), c.preventDefault ? c.preventDefault() : c.returnValue = !1;
                var f = b(".gt_slider_knob");
                S.na(b(".gt_slice"), "moving"), S.na(f, "moving");
                var g = c.clientX || c.changedTouches && c.changedTouches[0].clientX, h = c.clientY || c.changedTouches && c.changedTouches[0].clientY, j = f.getBoundingClientRect();
                Q.p("startX", g, a.id), Q.p("startY", h, a.id), na.h([Math.round(j.left - g), Math.round(j.top - h), 0], a.id), na.r([0, 0, 0], a.id), T.o(b(".gt_fullbg"), 300), T.o(b(".gt_guide_tip"), 500)
            }
        }
    }, ba.xa = function (a) {
        return function (b) {
            ...
            if ("moving" == c && "slide" == a.config.type && (!Q.f("pointerdown", a.id) || "pointermove" === b.type)) {
                ...
                var d = Q.f("startX", a.id), e = Q.f("startY", a.id), f = (b.changedTouches && b.changedTouches[0].clientX || b.clientX) - d, g = e - (b.changedTouches && b.changedTouches[0].clientY || b.clientY), h = parseInt(f);
                ba.l(h, a), na.r([Math.round(f), Math.round(g), (new Date).getTime() - Q.f("startTime", a.id)], a.id), a.config.benchmark && i("Benchmark").B(a)
            }
        }
    }, ba.ya = function (a) {
        var b = a.$;
        return function (c) {
            ...
            if ("moving" == d && "slide" == a.config.type && (!Q.f("pointerdown", a.id) || "pointerup" === c.type)) {
                ...
                d = Q.p("status", "lock", a.id), pa.ma("lock", a), S.oa(b(".gt_slice"), "moving"), S.oa(b(".gt_slider_knob"), "moving");
                var f = Q.f("startX", a.id), g = Q.f("startY", a.id), h = (c.changedTouches && c.changedTouches[0].clientX || c.clientX) - f, j = g - (c.changedTouches && c.changedTouches[0].clientY || c.clientY), k = new Date;
                Q.p("endTime", k, a.id), na.r([Math.round(h), Math.round(j), k.getTime() - Q.f("startTime", a.id)], a.id);
                var l = parseInt(h), n = na.s(a.id);
                if (a.config.offline) {
                    var o = i("Offline");
        ...
        var b = a.$, c = b(".gt_slider_knob"), d = ba.xa(a), e = ba.ya(a);
        Q.p("moveHandler", d, a.id), Q.p("upHandler", e, a.id), aa.u(c, W, ba.wa(a)), aa.u(document, V, d), aa.u(document, X, e)
    }, ba.t = function (a, b) {
    ...
    var ca = function (a) {
        ...
        for (var b = a.config.show_delay, c = a.config.hide_delay, d = Q.f("status", a.id), e = "ready" == d || "success" == d || "error" == d, f = Q.f("in", a.id), g = a.$(".gt_widget"), h = Q.f("hideDelay", a.id) || [], j = 0, k = h.length; j < k; j++)clearTimeout(h[j]);
        h = [];
        var l;
        if (e && !f) {
            if (S.pa(g, "gt_hide"))return;
            if ("curtain" == a.config.type) {
                var m = i("Curtain");
                l = m.setFloat(!1, a, c), h = h.concat(l)
            }
            h.push(T.o(g, 400, c)), Q.p("hideDelay", h, a.id)
        } else {
            if (S.pa(g, "gt_show"))return;
            if (b = e ? b : 0, "curtain" == a.config.type) {
                var m = i("Curtain");
                l = m.setFloat(!0, a, b), h = h.concat(l)
            }
            h.push(T.ma(g, 400, b)), Q.p("hideDelay", h, a.id)
        }
    }, ea = function (a, b) {
        ...
        var c = a.target || a.srcElement, d = Q.f("in", b.id), e = ea(c, b.dom);
        b.config.sandbox && !e && (e = ea(c, b.cloneDom)), d != e && (b.config.sandbox && S.da(b.cloneDom, b.dom), Q.p("in", e, b.id), k.q("hoverChange", b.id))
    }, ha = function (a) {
        var b = a.$;
        Q.p("in", !1, a.id), T.o(b(".gt_widget")), aa.u(document, "move", fa(a)), aa.u(document, "up", fa(a)), k.U("statusChange", ca(a), a.id), k.U("hoverChange", ca(a), a.id)
    }, ia = {};
    ia.Y = function (a, b) {
        a = a || z.lang;
        var c = R(a);
        ...
        var b = a.$;
        T.ma(a.dom, 400), "success" == Q.f("status", a.id) && a.refresh(), T.o(b(".gt_popup_finish")), T.ma(b(".gt_popup_ready"))
    }, ia.o = function (a) {
        T.o(a.dom, 400)
    }, ia.h = function (a) {
        if (a.config.mobile)return a;
        var b = Q.f("enablePopup", a.id);
        void 0 == b && Q.p("enablePopup", !0, a.id), k.U("success", function () {
            var b = a.$;
            T.ma(b(".gt_popup_finish")), T.o(b(".gt_popup_ready")), setTimeout(function () {
                ia.o(a);
        ...
        if (!Q.f("DOMReady", b.id))return void k.P("DOMReady", function () {
            ia.za.call(b, a)
        }, b.id);
        if ("popup" === b.config.product) {
            ...
            d.innerHTML = c.outerHTML, d = d.childNodes[0], c.style.display = "none", c.id = "origin_" + c.id, S.Z(c, d);
            try {
                d.href = "javascript:;"
            } catch (e) {
            }
            Q.p("popup_copy_btn", d, b.id), aa.u(d, "click", function (a) {
        ...
        var a = this, b = Q.f("enablePopup", a.id);
        return b && ia.ma(a), a
    ...
    var ja = function (a) {
        ...
        if (a.config.retry > 3)return w("can not loaded imgs"), void k.q("error", a.id);
        var b = Q.f("status", a.id);
        if ("ready" === b || "success" === b || "auto" === b) {
            if (k.q("statusChange", a.id), Q.p("status", "lock", a.id), qa.ra(a), a.config.mobile) {
                var c = i("SVG");
                c.g(a, !0)
                ...
                var e = a.$;
                U.ra(a.$), T.o(e(".gt_ie_success")), pa.ma("lock", a)
            }
            if (a.config.offline) {
                var f = i("Offline");
            ...
            G(a.config.apiserver + "refresh.php?" + m({
                ...
                return b ? (w("refresh error"), void k.q("error", a.id)) : void la(c, a)
            }, a)
        }
    }, la = function (a, b) {
        if (k.q("refresh", b.id), b.config.debugConfig && (a = l(b.config.debugConfig, a)), A(b.config, a), b.config.mobile) {
            var c = i("SVG");
            c.w(b)
        } else"gyroscope" === b.config.type ? i("Gyro").w(b) : (S.ga(b), S.ha(b), S.ka(b));
        clearTimeout(Q.f("autoRefresh", b.id)), Q.p("autoRefresh", setTimeout(function () {
            b.refresh()
        }, 54e4), b.id)
    };
    ...
    var ma = function (a) {
        ...
        } else aa.u(a.$(".gt_refresh_button"), "click", ja(a));
        Q.p("autoRefresh", setTimeout(function () {
            a.refresh()
        }, 54e4), a.id), k.U("success", function () {
        ...
        var a = function (a, b) {
            ...
            for (var b, f = c(Q.f("arr", a)), g = [], h = [], i = [], j = 0, k = f.length; j < k; j++)b = e(f[j]), b ? h.push(b) : (g.push(d(f[j][0])), h.push(d(f[j][1]))), i.push(d(f[j][2]));
    ...
    oa.qa = function (a, b, c, d) {
        ...
        var h, i = 3, j = function () {
            oa.qa(k, a, b.config.lang, {count: i}), i--, i == -1 && clearInterval(h)
        }, k = d(".gt_info_text"), l = {};
        if ("success" == a) {
            var m = (Q.f("endTime", b.id).getTime() - Q.f("startTime", b.id)) / 1e3;
            l.sec = m.toFixed(1), l.score = 100 - Q.f("score", b.id)
        } else"forbidden" == a && (j(), h = setInterval(j, 1e3), c = 4e3);
        "forbidden" != a && oa.qa(k, a, b.config.lang, l), T.ma(e, 200), c && Q.p("infoHide", T.o(e, 300, c), b.id)
    };
    var pa = {};
    pa.ma = function (a, b) {
        var c = b.$;
    ...
    qa.Aa = function (a, b) {
        ...
        Q.p("geetest_challenge", d, b.id), Q.p("geetest_validate", e, b.id), Q.p("geetest_seccode", f, b.id), c(".geetest_challenge").value = d, c(".geetest_validate").value = e, c(".geetest_seccode").value = f
    }, qa.va = function (a, b) {
        qa.Aa(a, b)
    }, qa.ra = function (a) {
        qa.Aa(!1, a)
    ...
    ra.onStatusChange = function (a, b) {
        ...
        var a = this, b = Q.f("onSuccess", a.id);
        "function" == typeof b && b.call(a), ra.onStatusChange("Success", a)
    }, ra.onRefresh = function () {
        var a = this, b = Q.f("onRefresh", a.id);
        "function" == typeof b && b.call(a), "function" == typeof window.gt_custom_refresh && window.gt_custom_refresh(a.$)
    }, ra.onFail = function () {
        var a = Q.f("onFail", this.id);
        "function" == typeof a && a.call(this), ra.onStatusChange("Fail", this)
    }, ra.onForbidden = function () {
        ra.onStatusChange("Forbidden", this)
    }, ra.onAbuse = function () {
        ra.onStatusChange("Abuse", this)
    }, ra.onError = function (a) {
        var b = this, c = Q.f("onError", b.id);
        "function" == typeof c && c.call(b), "function" == typeof window.gt_custom_error && window.gt_custom_error(b, b.$), a || (b.config.mobile ? k.q("SvgError", b.id) : (Q.p("status", "error", b.id), pa.ma("error", b), oa.ma("error", b, !1)), clearTimeout(Q.f("autoRefresh", b.id)))
    }, ra.onReady = function () {
        ...
        if ("function" == typeof a)return Q.p("onSuccess", a, this.id), this;
        throw new Error(e.callbackError)
    }, c.prototype.onFail = function (a) {
        if ("function" == typeof a)return Q.p("onFail", a, this.id), this;
        throw new Error(e.callbackError)
    }, c.prototype.onRefresh = function (a) {
        if ("function" == typeof a)return Q.p("onRefresh", a, this.id), this;
        throw new Error(e.callbackError)
    }, c.prototype.onError = function (a) {
        if ("function" == typeof a)return Q.p("onError", a, this.id), this;
        throw new Error(e.callbackError)
    }, c.prototype.onStatusChange = function (a) {
        if ("function" == typeof a)return Q.p("onStatusChange", a, this.id), this;
        throw new Error(e.callbackError)
    }, c.prototype.onReady = function (a) {
        if ("function" == typeof a)return Q.p("onReady", a, this.id), this;
        throw new Error(e.callbackError)
    }, c.prototype.getPasstime = function () {
        return Q.f("endTime", this.id) - Q.f("startTime", this.id)
    }, c.prototype.hideRefresh = function () {
        var a = this;
        if (!Q.f("DOMReady", a.id))return k.P("DOMReady", function () {
            a.hideRefresh()
        }, a.id), this;
        if (a.config.mobile) {
            var b = Q.f("eles", a.id);
    ...
    var sa = function (a, b) {
        ...
        var c = Q.f("eles", a.id);
        a.dom.style.width = b + "px", c.svg.style.width = b + "px", c.svg.style.height = Math.ceil(b * (a.config.height + Q.f("panelHeight", a.id)) / 260) + "px"
    };
    c.prototype.zoom = function (a) {
        var b = this;
        if (!Q.f("DOMReady", b.id))return k.P("DOMReady", function () {
            b.zoom(a)
        }, b.id), this;
        ...
        if (a.dom && a.dom.parentNode && a.dom.parentNode.removeChild(a.dom), "popup" === a.config.product) {
            var b = Q.f("popup_btn", a.id), c = Q.f("popup_copy_btn", a.id);
            c && c.parentNode && c.parentNode.removeChild(c), b && (b.style.display = "inline-block", b.id = b.id.replace("origin_", ""));
            var d = a.$(".gt_input");
            d && d.parentNode && d.parentNode.removeChild(d)
        }
        aa.ua(document, "move", Q.f("moveHandler", a.id)), aa.ua(document, "up", Q.f("upHandler", a.id)), Q.T(a.id), k.T(a.id)
    }, g.Q("Event", function () {
        return k
    ...
    var a = a || window;
    return a.Geetest ? (a.Geetest.type = a.Geetest.type || void 0, a.Geetest.type !== d.type ? ("slide" === c.type ? d.slide = c : (d.slide = a.Geetest, d[c.type] = c), a.Geetest = d) : a.Geetest[c.type] || (a.Geetest[c.type] = c)) : (d[c.type] = c, a.Geetest = d), a.Geetest.define || (a.Geetest.define = function (a, b, c) {
        g.Q(a, b, c)
    }), a.Geetest
});
