...
$.getScript("http://static.geetest.com/static/tools/gt.js?v=" + datastamp, function () {
    $.ajax({
        url: "/SearchItemCaptcha?v=" + datastamp, type: "get", dataType: "json", success: function (a) {
            initGeetest({gt: a.gt, challenge: a.challenge, product: "popup", offline: !a.success}, handlerPopup)
        }
    })
});
