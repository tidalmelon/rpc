(function (n, t) {
    ...
    var re = /Until$/, ue = /^(?:parents|prev(?:Until|All))/, fe = /^.[^:#\[\.,]*$/, br = i.expr.match.needsContext, ee = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    var u, y, p, ni = /alpha\([^)]*\)/i, ye = /opacity=([^)]*)/, pe = /^(top|right|bottom|left)$/, we = /^(none|table(?!-c[ea]).+)/, ru = /^margin/, be = new RegExp("^(" + ft + ")(.*)$", "i"), ot = new RegExp("^(" + ft + ")(?!px)[a-z%]+$", "i"), ke = new RegExp("^([-+])=(" + ft + ")", "i"), ti = {BODY: "block"}, de = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, uu = {
    ...
    i.fn.extend({
        position: function () {
            if (this[0]) {
                var u = this[0], n = this.offsetParent(), t = this.offset(), r = ri.test(n[0].nodeName) ? {
                    top: 0,
                    left: 0
                } : n.offset();
    ...
    function s() {
        var t, r = this, n = i(r), e = n, u = this.id;
        if (r.value == "") {
            if (r.type == "password") {
                if (!n.data("placeholder-textinput")) {
                    try {
                        ...
                        t = i("<input>").attr(i.extend(l(this), {type: "text"}))
                    }
    ...
    var u = "placeholder" in t.createElement("input"), e = "placeholder" in t.createElement("textarea"), h = i.fn, c = i.valHooks, o, r;
...
$.ajax({timeout: 5e3});
$.postJSON = function (n, t, i, r) {
    r == undefined && (r = "true");
    $.ajax({type: "POST", url: n, data: t, success: i, dataType: "json", async: r})
};
$.fn.setCursorPosition = function (n) {
    return this.lengh == 0 ? this : $(this).setSelection(n, n)
};
$.fn.setSelection = function (n, t) {
    ...
    if (input = this[0], input.createTextRange) {
        ...
        i.select()
    } else input.setSelectionRange && (input.focus(), input.setSelectionRange(n, t));
    return this
};
